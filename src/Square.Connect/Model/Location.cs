...
namespace Square.Connect.Model
{
    ...
    public partial class Location :  IEquatable<Location>, IValidatableObject
    {
        ...
        public Location(string Id = default(string), string Name = default(string), Address Address = default(Address), string Timezone = default(string), List<CapabilitiesEnum> Capabilities = default(List<CapabilitiesEnum>), LocationStatus? Status = default(LocationStatus?), string CreatedAt = default(string), string MerchantId = default(string), CountryEnum? Country = default(CountryEnum?), string LanguageCode = default(string), Currency? Currency = default(Currency?), string PhoneNumber = default(string), string BusinessName = default(string), LocationType? Type = default(LocationType?), string WebsiteUrl = default(string))
        {
            this.Id = Id;
            this.Name = Name;
        ...
        public string State
        {
            ...
            {
                if (Address != null)
                    return Address.AdministrativeDistrictLevel1;
                else
                    return _state;
            }
            set
